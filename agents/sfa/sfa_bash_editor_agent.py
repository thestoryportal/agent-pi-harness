...
Usage:
    # View a file
    uv run agents/sfa/sfa_bash_editor_agent.py --prompt "Show me the first 10 lines of README.md"

    # Create a new file
    uv run agents/sfa/sfa_bash_editor_agent.py --prompt "Create a new file called hello.txt with 'Hello World!' in it"

    # Replace text in a file
    uv run agents/sfa/sfa_bash_editor_agent.py --prompt "Create a new file called hello.txt with 'Hello World!' in it. Then update hello.txt to say 'Hello AI Coding World'"

    # Insert a line in a file
    uv run agents/sfa/sfa_bash_editor_agent.py --prompt "Create a new file called hello2.txt with 'Hello AI Coding World!' in it. Then add a new line 'How are you?' after 'Hello AI World!' in hello.txt"

    # Execute a bash command
    uv run agents/sfa/sfa_bash_editor_agent.py --prompt "List all Python files in the current directory sorted by size"

    # Complete a multi-step task
    uv run agents/sfa/sfa_bash_editor_agent.py --prompt "List all Python files in the current directory sorted by size, then output to a markdown file called python_files_sorted_by_size.md"
"""
